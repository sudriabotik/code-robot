...
/**
 * Fonction qui permet d'afficher sur la liaison série la position en temps réel
 * des ax12 choisis
 * @param ax12      : tableau avec les id des ax12 à checker
...
/******************************************************************************/
/******************** FONCTIONS COUPE 2017 - PETIT ROBOT *********************/
/******************************************************************************/


void bras(uint8_t _tcote, uint8_t position);
