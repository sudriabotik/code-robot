...
int main(int argc, char** argv)
{
    ...
    // Test fonctionnement AX-12 billes
    
    angle_AX12(12, (1024-200), 150, SANS_ATTENTE);
    angle_AX12(22, (200), 150, SANS_ATTENTE);
    delay_ms(1000);
    angle_AX12(12, 512, 150, SANS_ATTENTE);
    angle_AX12(22, 512, 150, SANS_ATTENTE);
    
    while(!SYS_JACK);
    strategie();
    //homologation();
    //rejoindre(950,0, MARCHE_AVANT, 30);

    
    
    //while(1) {avancer_reculer(1000.0,20.0);}

    //delay_ms(1000);
    //envoit_pwm(MOTEUR_X, PWM_X_VALEUR_MAX/2.5);
    //delay_ms(10000);
    //envoit_pwm(MOTEUR_X, PWM_X_VALEUR_MAX/3);
