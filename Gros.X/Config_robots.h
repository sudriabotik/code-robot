...
#define _Pi                             3.14159265359
    ...
    #define CAPT_US_AV_GAUCHE           CAPTEUR4
    #define CAPT_US_AV_CENTRE           CAPTEUR1
    
    #define CAPT_US_AR_DROIT            CAPTEUR3
    ...
    #define _CAPT_ADV_AVANT_C            CAPT_US_AV_CENTRE

    #define _ETAT_ADV_AVANT_G            ETAT_HAUT
    #define _ETAT_ADV_AVANT_D            ETAT_HAUT
    #define _ETAT_ADV_AVANT_C            ETAT_BAS
