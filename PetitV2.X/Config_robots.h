...
#define _Pi                             3.14159265359
    ...
    #define _MAX_E_INTEGRALLE_BRAKE      3500. //12000
    ...
    #define KP_BRAKE                    0.09 //0.12
    #define KI_BRAKE                    0.0025 //0.0015
    #define KD_BRAKE                    0.03 //0.02
    ...
    #define CAPT_US_AV_GAUCHE           CAPTEUR2
    #define CAPT_IR_AV_CENTRE           CAPTEUR3//4
    #define CAPT_IR_AV_GAUCHE           CAPTEUR5
    #define CAPT_IR_AV_DROIT            CAPTEUR7
    
    #define CAPT_US_AR_DROIT            CAPTEUR6//7
    ...
    #define _CAPT_ADV_AVANT_C            AUCUN//CAPT_IR_AV_CENTRE

    #define _ETAT_ADV_AVANT_G            ETAT_BAS
    #define _ETAT_ADV_AVANT_D            ETAT_BAS
    #define _ETAT_ADV_AVANT_C            ETAT_HAUT//ETAT_BAS
